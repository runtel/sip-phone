...
from statusCmdButton import QStatusCmdButton

class statusCmdButtonPlugin(QPyDesignerCustomWidgetPlugin):
    """
...
#        QPyDesignerCustomWidgetPlugin.__init__(self, parent)
        super(statusCmdButtonPlugin, self).__init__(parent)
    ...
    def createWidget(self, parent):
        ...
        return QStatusCmdButton(parent)

    def name(self):
        # этод метод должен вернуть имя класса виджета
        return "QStatusCmdButton"
    ...
    def toolTip(self):
        ...
        return u"QButton с цветовым состоянием"
    ...
    def domXml(self):
        ...
        # вставляется в .ui
        return "<widget class=\"QStatusCmdButton\" name=\"statusCmdButton\">\n"\
               "</widget>\n" \
#               "    <property name=\"green\">\n"\
#               "        <bool>false</bool>\n"\
#               "    </property>\n"\
